    ...
    return (
        <>
            ...
            <section id={"checkout-section"}>
                <NavBar Heading={"Checkout"} displayBackButton={true}/>
                            ...
                            <React.Fragment key={item.productId}>
                                <article className="meal-item">
                                    ...
                                    <div className="meal-info">
                                        ...
                                        <span
                                            className="meal-price">R{(item.priceAtPurchase * item.quantity).toFixed(2)}</span>
                                    </div>
                                    <button
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                             ...
                                             strokeLinejoin="round" className="trash-icon">
